...
// Permitir solo perfil Ventas (id_perfil = 3)
verificar_perfil([3]);
...
if (!file_exists($imgPath)) {
    $imgPath = "../../public/img/Usuarios/Dama2.jpg"; // Imagen genérica si no existe la personal
}
...
?>
    ...
    <main 
        class="p-4 flex-grow-1 fade-in" id="contenido">
        <div class="text-center mb-4">

        <!-- Imagen circular del usuario -->
        <img src="<?= $imgPath ?>" alt="Foto de <?= htmlspecialchars($nombreUsuario) ?>" 
